...
def form_data(input_filename):
    ...
    with open(input_filename, 'r') as input_file:
        ...
        for line in input_file:
            ...
            frame_type.append(0 if parts[-1] == 'R' or parts[-1] == 'B' else 1)
...
def convert_to_json(input_filename,json_filename):
    ...
    dci_json_path = os.path.dirname(json_filename)
    os.makedirs(dci_json_path, exist_ok=True)
...
# if __name__ == "__main__":
    ...
    # convert_to_json(os.path.join(dir_path,"../../datasets/MIRGU/modified_dataset/DoS_attack.csv"),"hello.json")
